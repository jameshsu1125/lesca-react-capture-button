  ...
  return new Promise(function (resolve, reject) {
    ...
    reader.onload = function (e) {
      ...
      image.onload = function (event) {
        ...
        _exif["default"].getData(fakeImage, function () {
          var orientation = _lescaUserAgent["default"].get() === _lescaUserAgent.UserAgentType.Mobile ? _exif["default"].getTag(image, 'Orientation') : 1;
          switch (orientation) {
            case 1: // 水平(一般)
            case 6:
